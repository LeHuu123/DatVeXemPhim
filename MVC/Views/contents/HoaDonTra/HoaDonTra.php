...
$listVe = $data['listVeDaDat'];
// echo "<pre>";
// print_r(mysqli_fetch_assoc($listVe));
// echo "</pre>";
...
if (isset($_POST['btnXuatExcel'])) {
    ...
    while ($row = mysqli_fetch_assoc($listVe)) {
        if (!$row['trangThai']) {
            array_push($patient, $row);
        }
    }

    $headerRowData = ['Mã vẽ', 'Khách hàng', 'Ngày đặt', 'Tên phim', 'Tên rạp', 'Phòng', 'Suẩt chiếu', 'Tổng tiền', 'Số điện thoại', 'Ghi chú', 'Com bo', 'Số ghế', 'Trạng thái', 'Lý do', 'id phim'];
    $columnIndex = 1;
...
<body>
    <h2 class="title_MAIN"> Hóa đơn trả </h2>
    <div class="rap_container">
        <div class="SanPham">
            <form method="POST" action="" class="formVeDaDat">
                <!-- <h4 class="mb-3" style="text-align: center;">Hóa đơn trả </h4> -->
                <div class="container">
                    <div class="">
        ...
        <div id="table-wrapper">
            <div id="table-scroll">
                <table class="table table-striped">
                    ...
                    if (isset($listVe) && $listVe != null) {

                        while ($row = mysqli_fetch_array($listVe)) {
                    ...
                    ?>
                        ...
                        <td>
                            <a style="color:red;margin-right:10px;text-decoration:none; font-weight:bold"><i class="callTraVe fa-solid fa-rotate-left"></i> </a>
                                    ...
                                    <td class="noactive"> Trả thành công</td>
                                    <!-- <td>
