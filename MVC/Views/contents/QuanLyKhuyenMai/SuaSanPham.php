         ...
         <form method="POST" action="">
            ...
            ?>
                  ...
                  <input type="text" class="form-control"
                     placeholder="Mã sản phẩm" name = "txtMa" value="<?php echo $row['idSanPham']?>"readonly>
               </div>
               <div class="form-group col-sm-6">
            ...
            <div class="form-row">
               ...
               <div class="form-group col-sm-4">
                  ...
                  <input type="number" class="form-control" min="0" placeholder="Số lượng" name = "txtSoLuong" value="<?php echo $row['soLuong']?>">
               </div>
            </div>
